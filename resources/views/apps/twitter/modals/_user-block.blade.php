<div>
    ...
    <div class="flex items-center justify-between">
        <h5 class="mr-3 font-bold text-lg text-black max-w-none">Block</h5>               
    ...
    <div class="mt-5 py-2">
        ...
        <div class="flex w-full justify-between">
            ...
            <button wire:click="handleBlock()" class="inline-flex px-4 py-2 rounded-full text-white bg-red-500 hover:bg-red-400">
